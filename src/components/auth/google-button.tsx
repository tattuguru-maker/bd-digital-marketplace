...
export function GoogleButton({ next }: { next?: string }) {
  return (
    <form action={loginWithGoogle}>
      ...
      <button
        type="submit"
        className="group relative flex h-11 w-full items-center justify-center gap-2 rounded-lg border border-white/10 bg-white/[0.04] text-[14px] font-medium text-fg transition hover:bg-white/[0.08]"
      >
        <GoogleIcon />
